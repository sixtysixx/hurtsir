...
1. **Roblox Settings:** Open Roblox settings and disable **"Launch on startup"** and **"Minimize to tray when closed"**. Close and reopen Roblox to apply.
2. **SirHurt Cleaner:** If issues persist, run the [SirHurt Cleaner](https://github.com/i-nagap/Sirstrap/releases/) (bundled with Sirstrap). Press `Y` + `Enter` for all prompts. *Note: This will clear your auth data.*
3. **Beta Version:** Use the downgrade tutorial if you get an error about being on a unsupported version, check [#customer-announcements](https://discord.com/channels/1364170844867399722/1364178960354906183) in discord for more info. Youll need to link your discord and sirhurt account if youre unable to see the channel.
...
1. **Launch:** Open Roblox and join a game.
...
Guide - Made by <a href="https://discord.com/users/1045933816260350032">SIX</a> - See an issue? Let me know! (best CSR frfr)
