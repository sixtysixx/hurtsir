...
5. Extract (DONT USE WINDOWS DEFAULT EXTRACT ISTG) and run the **SirHurt Cleaner** — press `Y` for all prompts (see Section 5).
...
10. Close Roblox.
11. Reopen Roblox.
12. Extract SirHurt (**7-Zip** preferred).
13. Run the Bootstrapper as **Administrator**.
14. Attempt to inject, then login.
15. Execute a test script (e.g. **Infinite Yield**).
